...
import com.example.marsphotos.ui.screens.CombinedImageScreen
        ...
        setContent {
            MarsPhotosTheme {
                Surface(
                    ...
                    PicsumPhotosApp(picsumViewModel)
                    MarsPhotosApp(marsViewModel)

                    CombinedImageScreen(marsViewModel, picsumViewModel, db, imagesRef)
